...
namespace Compr.Tests.Sessions
{
    public abstract class ComprTestBase : AbpIntegratedTestBase
    {
        protected ComprTestBase()
        {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<ComprApplicationModule>();
            modules.Add<ComprDataModule>();
        }

        public void UsingDbContext(Action<ComprDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<ComprDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<ComprDbContext, T> func)
        {
            T result;
